...
export default function Messagerie() {
  ...
  useEffect(() => {
    setNewContracts(
      contracts.filter((contract: contractOfferDto) => contract.isNew),
    );
    setOldContracts(
      contracts.filter((contract: contractOfferDto) => !contract.isNew),
    );
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Skeleton className="h-10 w-1/2 rounded-md mt-24" />
        ...
        <Skeleton className="h-10 w-1/2 rounded-md mt-12" />
          ...
          {selectedSponsor ? (
            <>
              ...
              <div className="flex flex-col gap-4">
                {selectedSponsor.sponsorName && (
                  <span className="text-xl font-extrabold text-black mb-20">
                    {selectedSponsor.sponsorName}
                  </span>
                )}
                ...
                <div className="space-y-10 relative z-10">
                  ...
                  {selectedSponsor.messages &&
                    selectedSponsor.messages.length > 0 && (
