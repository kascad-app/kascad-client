...
export default function AthleteProfile() {
  ...
  const handleShowMoreVideos = () =>
    setVisibleVideos((prev) => Math.min(prev + 4, Profile.videos.length));
  const handleResetVideos = () => setVisibleVideos(4);
  const handleShowMoreImages = () =>
    setVisibleImages((prev) => Math.min(prev + 4, Profile.images.length));
    ...
    <div className="overflow-x-hidden">
      ...
      <div className="profile_medias relative bg-black py-24">
        <div className="mt-8 px-24">
          <h3 className="mb-10 text-4xl font-[Michroma] text-white uppercase">
            Vidéos
          </h3>
        ...
        {Profile.instagram && (
          <div className="mt-64 bg-black py-18 px-24">
            ...
            <div className="mb-[18px] text-[32px] font-michroma text-white text-center">
