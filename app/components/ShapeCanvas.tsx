  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      if (elapsedTime > redrawIntervalRef.current) {
        ...
        canvas.width = canvasWidth ?? document.documentElement.clientWidth;
        canvas.height = canvasHeight ?? document.documentElement.clientHeight;
        ...
        const tween = () => {
          ...
          gradient.addColorStop(0, "rgba(210, 250, 82, 0.46)"); // Couleur centrale avec opacité
          gradient.addColorStop(1, "rgba(210, 250, 82, 0.46)"); // Couleur extérieure avec opacité
