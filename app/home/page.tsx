        ...
        <main className="min-h-screen bg-white text-black flex flex-col justify-between relative">
            ...
            <section className="relative w-full h-[70vh] overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col justify-center items-center gap-10 px-10 text-white">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 font-michroma">Bonjour Marie-Claire 👋</h1>
                    {/* <p className="text-lg max-w-xl mb-6">
                        Ne soyez plus seulement celle qui cherche, soyez aussi celle que l’on trouve.
                    </p> */}
                    <Link href="/profil">
                        <Button className="bg-transparent border-white border-2 text-white font-semibold hover:bg-gray-100 hover:text-black p-[1.5rem]">Accéder à mon profil</Button>
                    </Link>
                </div>
            </section>
            ...
            <section className="p-8 md:px-[12%] md:py-[7%] bg-white flex flex-col gap-8 text-center md:text-start items-center justify-center">
                <p className="text-lg mb-6 w-full">
                    ...
                    Indiquez votre disponibilité et complétez votre profil pour que les sponsors qui recrutent vous contactent directement.
                </p>
                ...
                <div className="flex flex-col lg:flex-row w-full justify-start gap-12 md:gap-24 items-center">
                    ...
                    <div className="rounded relative p-8 bg-blue-200 overflow-hidden w-full lg:w-1/2">
                        <div className="flex flex-col gap-6 md:gap-12 max-w-full md:max-w-[60%]">
                            <p className="text-center md:text-start">Accéder à votre profil et rentrez vos informations !</p>
                            <Link href="/profil">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                        <div className="flex flex-col items-center md:items-start text-center p-6 gap-4 rounded-xl transition w-full border border-blue-700">
                            ...
                            <Link href="/portfolio" className="w-1/2">
                                <Button variant="outline" className="text-blue-700 bg-white text-white border-blue-700 hover:bg-blue-700 hover:text-white text-blue-700 w-full">
                                    ma messagerie
                                </Button>
                            </Link>
                        </div>
            ...
            {/* Call to action */}
            <section className="relative w-full h-[60vh] bg-cover bg-center" style={{ backgroundImage: "url('/assets/img/ctaBG.webp')" }}>
                <div className="absolute inset-0 bg-black/40" />
                <div className="relative z-10 h-full flex flex-col justify-center items-center text-white text-center px-6">
                    <h2 className="text-3xl md:text-4xl font-bold mb-8">Complétez votre profil pour apparaître dans les recherches</h2>
                    <Link href="/profil">
                        <Button className="bg-transparent border-white border-2 text-white font-semibold hover:bg-gray-100 hover:text-black p-[1.5rem]">Compléter mon profil</Button>
                    </Link>
                </div>
            </section>
