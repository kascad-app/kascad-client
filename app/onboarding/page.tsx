...
function backBoard(): void {
  ...
  return (
    <div className="w-full max-w-screen h-screen max-h-full overflow-hidden relative flex flex-col  items-center justify-center">
      ...
      <div className={ pageNumber > 1 ? "flex justify-between w-1/2 px-10" : "flex justify-end w-1/2 px-10"}>
        { pageNumber > 1 ? <button className="mr-4" onClick={backBoard}>Return</button> : "" }
