...
export default function MarketPlacePage() {
  ...
  const listAllResultItems: ListItem[] = [
    ...
    { "id": 5, "date": "5", "event": "Under Armour", "categorie": "Training", "top": "170" },
    { "id": 6, "date": "6", "event": "Asics", "categorie": "Running", "top": "160" },
    { "id": 7, "date": "7", "event": "New Balance", "categorie": "Running", "top": "150" },
    ...
    { "id": 15, "date": "15", "event": "Hoka One One", "categorie": "Running", "top": "70" },
    { "id": 16, "date": "16", "event": "Fila", "categorie": "Tennis", "top": "60" },
    { "id": 17, "date": "17", "event": "Converse", "categorie": "Casual", "top": "50" },
    { "id": 18, "date": "18", "event": "Vans", "categorie": "Skateboarding", "top": "40" },
    { "id": 19, "date": "19", "event": "DC Shoes", "categorie": "Skateboarding", "top": "30" },
    { "id": 20, "date": "20", "event": "Timberland", "categorie": "Outdoor", "top": "20" },
    { "id": 21, "date": "21", "event": "North Face", "categorie": "Outdoor", "top": "10" },
    { "id": 22, "date": "22", "event": "Patagonia", "categorie": "Outdoor", "top": "200" },
    { "id": 23, "date": "23", "event": "Lululemon", "categorie": "Yoga", "top": "190" },
    { "id": 24, "date": "24", "event": "Arc'teryx", "categorie": "Outdoor", "top": "180" },
    { "id": 25, "date": "25", "event": "La Sportiva", "categorie": "Climbing", "top": "170" },
    { "id": 26, "date": "26", "event": "Inov-8", "categorie": "Trail Running", "top": "160" },
    { "id": 27, "date": "27", "event": "Keen", "categorie": "Outdoor", "top": "150" },
    { "id": 28, "date": "28", "event": "Altra", "categorie": "Running", "top": "140" },
    { "id": 29, "date": "29", "event": "On Running", "categorie": "Running", "top": "130" },
    { "id": 30, "date": "30", "event": "Topo Athletic", "categorie": "Running", "top": "120" },
  ...
  return (
    <>
      ...
      <div className="px-24 py-7">
        ...
        <List title={secondListTitle} items={listAllResultItems} columns={columnTitles} growing = {true} threshold={3}/>
      </div>
      <Footer />
    </>
  );
